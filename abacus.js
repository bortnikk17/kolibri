  ...
  this.init = function() {
    ...
    for(var i=0; i < this.beadLines; i++) {
      for(var j=0; j < this.beadPerLine; j++) {
        var bead = new Bead();
        bead.position[0] = 440 - i * this.beadSpacing;
...
function Abacus(parentDivId, type) {
  ...
  var beadColor = "#AB4DF8";
  var hooveredBeadColor = "#833ABE";
  ...
  this.update = function() {
    ...
    var textY = 500 + (abacusCtrl.beadPerLine+2) * abacusCtrl.beadHeight;
    for(var i=0; i < abacusCtrl.beadLines; i++) {
